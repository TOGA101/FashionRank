...
#
# Notes
# - This script imports the SHAPY regressor utilities from the `inference.py` file
#   located in the same directory as this script. Ensure that file exists.
...
# -------------------------------------------------------------------------
# Import SHAPY regressor utilities from the provided file `inference.py`.
...
def main() -> None:
    ...
    with open(os.devnull, "w") as devnull, contextlib.redirect_stdout(devnull), contextlib.redirect_stderr(devnull):
        ...
        pbar = tqdm(img_paths, desc="Extracting SHAPY betas", unit="img", file=original_stderr)
